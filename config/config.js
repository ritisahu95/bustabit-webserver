...
module.exports = {
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6LfpMycaAAAAAO8gvENe7ohaUHUIMBF4IuDP1GXc',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6LfpMycaAAAAANhITSwfgkJZP7f-wlBjhkTy04WE',
