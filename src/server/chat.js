...
Chat.prototype.sendMessageToChannel = function(channelName, msg, userID) {
    ...
    this.saveChatMessage(userID, msg.message, msg.type, channelName, msg.bot, msg.date);
};

Chat.prototype.saveChatMessage = function(userId, message, type, channelName, isBot, date) {
    db.addChatMessage(userId, date, message, type, channelName, isBot, function(err) {
       if(err)
